...
#------------------------------------------------------------------------
# read *.dat from "C:\Users\username\Documents\data_Basic3_no3.csv"
if(SW==2){

  # read *.csv file
  DATA<-read.csv("data_Basic3_no3.csv")

} # end "if(SW==2){"
#------------------------------------------------------------------------

# set list data (from DATA)
DATA_S<-list(N=nrow(DATA),Y=DATA$y,Z_m=DATA$z1,ZZ_1=DATA$X1,ZZ_2=DATA$X2)
